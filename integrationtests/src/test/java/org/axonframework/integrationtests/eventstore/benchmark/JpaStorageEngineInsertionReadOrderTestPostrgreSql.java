...
@ContextConfiguration(locations = "classpath:/META-INF/spring/insertion-read-order-test-postgresql-context.xml")
public class JpaStorageEngineInsertionReadOrderTestPostrgreSql {

    private static final Logger logger = LoggerFactory.getLogger(JpaStorageEngineInsertionReadOrderTestPostrgreSql.class);
